          ...
          <div class="row mb-5">
            ...
            <div class="col-lg-6">
              ...
              @if ($product->compare_price > $product->price)
                ...
                @endif
                &nbsp;
              <span class="text-muted lead">Rs. {{ number_format($product->price) }}</span>
          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="product text-center skel-loader">
                ...
                @if ($relatedProduct->compare_price > $relatedProduct->price)
                <span class="small text-danger" style="text-decoration: line-through;">Rs. {{ number_format($relatedProduct->compare_price) }}</span>
                @endif
                &nbsp;
                <span class="small text-muted">Rs. {{ number_format($relatedProduct->price) }}</span>
              </div>
            </div>
            @endforeach
            <!-- PRODUCT-->
