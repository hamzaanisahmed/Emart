            ...
            <div class="modal-body p-0">
              <div class="row align-items-stretch">
                <div class="col-lg-6 p-lg-0">
                    <a class="glightbox product-view d-block h-100 bg-cover bg-center"  href="" data-gallery="gallery1" data-glightbox="Red digital smartwatch">
                    </a>
                    <a class="glightbox d-none" href="" data-gallery="gallery1" data-glightbox="Red digital smartwatch">
                    </a>
                    <a class="glightbox d-none" href="" data-gallery="gallery1" data-glightbox="Red digital smartwatch">
                    </a>
                </div>
          ...
          <div class="row">
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
              <div class="product text-center">
                ...
                @endif
                &nbsp;
                <span class="small text-muted">Rs. {{ $product->price }}</span>
              </div>
              <br>
            </div>
            @endforeach
