    ...
    <div class="dashboard-ecommerce">
        <div class="container-fluid dashboard-content">
            ...
            <section class="content">
                <!-- Default box -->
                <form action="" name="updateAdminUserForm" id="updateAdminUserForm">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="name" id="name" class="form-control" placeholder="Full Name" value="{{ $user->name }}" autocomplete="off">
                                        <span class="p"></span>	
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" name="phone_number" id="phone_number" value="{{ $user->phone }}" class="form-control" placeholder="Phone Number">
                                        <span class="p"></span>	
                                    </div>
                                </div>
                                <div class="col-md-6">
...
<script>
    $(document).ready(function() {
        ...
        $("#updateAdminUserForm").submit(function(event) {
