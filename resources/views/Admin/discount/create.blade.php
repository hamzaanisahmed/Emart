    ...
    <div class="dashboard-ecommerce">
        <div class="container-fluid dashboard-content ">
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="page-header">
                        ...
                        <a href="{{ route('discountCoupons') }}" class="btn btn-primary productsbtn"><i class="fa fa-list"></i> Back</a>
                    </div>
                </div>
            </div>
            <!-- ============================================================== -->
            ...
            <section class="content">
                <!-- Default box -->
                <form action="" name="discountCoupunsForm" id="discountCoupunsForm">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="name" id="name" class="form-control" placeholder="Coupon Code Name" autocomplete="off">	
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea type="text" name="description" id="description" class="form-control" placeholder="Coupons Code Description"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>							
...
<script>
    $(document).ready(function() {
        ...
        $("#discountCoupunsForm").submit(function(event) {
            event.preventDefault();
            let formData = $(this).serializeArray();

            $.ajax({

                url: "{{ route('disountCouponsStore') }}",
                type: "post",
                data: formData,
                dataType: "json",
                success: function (response) {
                    ...
                    if (response.status == true) {
                        ...
                        // Success Alert.
                        swal("", "Discount Coupons Has Been Created Successfully!", "success")
                            .then(() => {
